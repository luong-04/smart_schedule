...
/**
 * Seeder nạp dữ liệu mẫu chạy thử nghiệm (Sample Data).
 * Dọn dẹp database và nạp lại dữ liệu mô phỏng.
 */
class SampleDataSeeder extends Seeder
{
    public function run(): void
    {
        // Vô hiệu hóa ràng buộc khóa ngoại để dọn dẹp dữ liệu sạch sẽ
        ...
        // 2. Khởi tạo Môn học (Chương trình GDPT 2018)
        $subjectsData = [
        ...
        // 3. Khởi tạo danh sách Phòng học
        for ($i = 1; $i <= 20; $i++) {
        ...
        // 4. Khởi tạo danh sách Giáo viên (60 giáo viên)
        $teacherNames = [
            'Nguyễn Văn An', 'Trần Thị Bình', 'Lê Văn Cường', 'Phạm Thị Dung', 'Hoàng Văn Em',
            'Vũ Thị Phương', 'Đỗ Văn Giang', 'Bùi Thị Hoa', 'Phan Văn Hùng', 'Ngô Thị Lan',
            'Lý Văn Minh', 'Đặng Thị Ngọc', 'Mai Văn Nam', 'Trịnh Thị Oanh', 'Đoàn Văn Phúc',
            'Quách Thị Quỳnh', 'Sơn Văn Sang', 'Thái Thị Thảo', 'Uông Văn Uy', 'Vi Thị Vân',
            'Lương Văn Xứng', 'Triệu Thị Yên', 'Hà Văn Zinh', 'Tạ Văn Hải', 'Cao Thị Liên',
            'Dương Văn Quân', 'Chu Thị Mai', 'Nông Văn Thắng', 'Lâm Thị Tuyết', 'Âu Văn Vương',
            'Phùng Văn Đạt', 'Mạc Thị Cúc', 'Tô Văn Bính', 'Hồ Thị Đào', 'Bạch Văn Định',
            'Trần Văn Hưng', 'Lê Thị Mỹ', 'Phạm Văn Thành', 'Hoàng Thị Yến', 'Vũ Văn Khải',
            'Đỗ Thị Thư', 'Bùi Văn Tâm', 'Phan Thị Ngọc', 'Ngô Văn Lộc', 'Lý Thị Hà',
            'Đặng Văn Khoa', 'Mai Thị Diệp', 'Trịnh Văn Quý', 'Đoàn Thị Trang', 'Quách Văn Bảo',
            'Thái Văn Chương', 'Vi Thị Hồng', 'Dương Văn Tiến', 'Chu Thị Phượng', 'Lâm Văn Sỹ',
            'Âu Thị Nga', 'Phùng Văn Khang', 'Mạc Thị Lan', 'Tô Văn Toàn', 'Hồ Thị Bích'
        ];
        ...
        // 5. Khởi tạo danh sách Lớp học (15 lớp)
        $grades = [10, 11, 12];
        ...
        // 6. Định mức tiết học (Subject Configurations)
        $compulsory = [
            'Toán học' => 3, 'Ngữ văn' => 3, 'Tiếng Anh' => 3, 'Lịch sử' => 2,
            'Giáo dục thể chất' => 2, 'Giáo dục quốc phòng và an ninh' => 1,
            'Hoạt động trải nghiệm, hướng nghiệp' => 3, 'Nội dung giáo dục địa phương' => 1
        ];
        ...
        // 7. Phân công giảng dạy (Assignments)
        $subjectTeachers = [];
        $tIdx = 0;
