...
@section('title', 'Thêm Phòng học mới')
@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-blue-50">
        <div class="flex items-center gap-4 mb-8">
            ...
            <h3 class="font-black text-slate-700 uppercase text-xs tracking-widest">Thông tin phòng học chi tiết</h3>
        </div>

        <form action="{{ route('rooms.store') }}" method="POST" class="space-y-6">
            @csrf
            <div>
                <label class="text-[10px] font-black text-slate-400 uppercase ml-2 mb-2 block">Tên phòng (VD: Lab 1, Phòng 101)</label>
            ...
            <div>
                <label class="text-[10px] font-black text-slate-400 uppercase ml-2 mb-2 block">Loại hình phòng</label>
