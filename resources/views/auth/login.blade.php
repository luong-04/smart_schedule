...
<body class="bg-gray-100 font-sans antialiased text-gray-900">
    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 to-indigo-800 px-4">
        <div class="max-w-md w-full bg-white rounded-2xl shadow-2xl overflow-hidden p-8 space-y-8 transform transition-all hover:scale-[1.01]">
            ...
            <div class="text-center">
                <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-100 mb-4 shadow-inner">
                    <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422M12 14v6m-3-3l3 3m0 0l3-3m-3 3V14"></path>
                    </svg>
                </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                @if ($errors->any())
                    <div class="bg-red-50 text-red-500 px-4 py-3 rounded-lg text-sm border border-red-100 flex items-center">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="admin@domain.com"
            ...
            <div class="text-center text-xs text-gray-400 mt-6 pt-6 border-t border-gray-100">
                &copy; {{ date('Y') }} Smart Schedule System.<br>Developed with ❤️
            </div>
        </div>
    </div>
</body>
