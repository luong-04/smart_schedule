        ...
        <aside class="w-[280px] lg:w-[20%] bg-[#F0F7FF] border-r border-slate-200 flex flex-col p-6 gap-6 sticky top-0 h-screen shrink-0 transition-all duration-300">
            ...
            <div class="flex items-center gap-3 px-2 overflow-hidden hover:scale-[1.02] transition-transform cursor-default">
                ...
                <div class="overflow-hidden">
                    <h1 class="text-[13px] font-black text-blue-800 uppercase leading-tight truncate w-full" title="{{ \App\Models\Setting::getVal('school_name', 'TRƯỜNG CHƯA CÀI ĐẶT') }}">
                        {{ \App\Models\Setting::getVal('school_name', 'TRƯỜNG CHƯA CÀI ĐẶT') }}
                    </h1>
                    <p class="text-[9px] text-slate-500 font-bold uppercase tracking-widest mt-1 truncate">
            ...
            <nav id="sidebar-nav" class="flex-1 flex flex-col gap-6 overflow-y-auto custom-scrollbar pr-2 mt-2">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        <a href="{{ route('admin.dashboard') }}" class="premium-sidebar-item flex items-center gap-3 px-3 py-3 rounded-xl transition-all {{ request()->routeIs('admin.dashboard') ? 'sidebar-item-active font-bold shadow-sm' : 'text-slate-600 hover:bg-white hover:text-blue-600 hover:shadow-sm' }}">
                            <span class="material-symbols-outlined {{ request()->routeIs('admin.dashboard') ? 'text-blue-600' : 'text-slate-400' }}">dashboard</span>
                            <span class="text-sm">Dashboard</span>
                        </a>
                        <a href="{{ route('schedules.list') }}" class="premium-sidebar-item flex items-center gap-3 px-3 py-3 rounded-xl transition-all {{ request()->routeIs('schedules.list') ? 'sidebar-item-active font-bold shadow-sm' : 'text-slate-600 hover:bg-white hover:text-blue-600 hover:shadow-sm' }}">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <a href="{{ route('teachers.index') }}" class="premium-sidebar-item flex items-center gap-3 px-3 py-3 rounded-xl transition-all {{ request()->routeIs('teachers.*') ? 'sidebar-item-active font-bold shadow-sm' : 'text-slate-600 hover:bg-white hover:text-blue-600 hover:shadow-sm' }}">
                        ...
                        @can('quan_ly_mon_hoc')
                        <a href="{{ route('subjects.index') }}" class="premium-sidebar-item flex items-center gap-3 px-3 py-3 rounded-xl transition-all {{ request()->routeIs('subjects.*') ? 'sidebar-item-active font-bold shadow-sm' : 'text-slate-600 hover:bg-white hover:text-blue-600 hover:shadow-sm' }}">
                        ...
                        @can('quan_ly_lop_hoc')
                        <a href="{{ route('classrooms.index') }}" class="premium-sidebar-item flex items-center gap-3 px-3 py-3 rounded-xl transition-all {{ request()->routeIs('classrooms.*') ? 'sidebar-item-active font-bold shadow-sm' : 'text-slate-600 hover:bg-white hover:text-blue-600 hover:shadow-sm' }}">
                        ...
                        <a href="{{ route('rooms.index') }}" class="premium-sidebar-item flex items-center gap-3 px-3 py-3 rounded-xl transition-all {{ request()->routeIs('rooms.*') ? 'sidebar-item-active font-bold shadow-sm' : 'text-slate-600 hover:bg-white hover:text-blue-600 hover:shadow-sm' }}">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <a href="{{ route('admin.proctors.index') }}" hx-boost="false" class="premium-sidebar-item flex items-center gap-3 px-3 py-3 rounded-xl transition-all {{ request()->routeIs('admin.proctors.*') ? 'sidebar-item-active font-bold shadow-sm' : 'text-slate-600 hover:bg-white hover:text-blue-600 hover:shadow-sm' }}">
                        ...
                        @role('Super Admin')
                        <a href="{{ route('users.index') }}" class="premium-sidebar-item flex items-center gap-3 px-3 py-3 rounded-xl transition-all {{ request()->routeIs('users.*') ? 'sidebar-item-active font-bold shadow-sm' : 'text-slate-600 hover:bg-white hover:text-blue-600 hover:shadow-sm' }}">
                        ...
                        <a href="{{ route('admin.settings.index') }}" class="premium-sidebar-item flex items-center gap-3 px-3 py-3 rounded-xl transition-all {{ request()->routeIs('admin.settings.*') ? 'sidebar-item-active font-bold shadow-sm' : 'text-slate-600 hover:bg-white hover:text-blue-600 hover:shadow-sm' }}">
            ...
            <div class="mt-auto pt-6 border-t border-blue-100 shrink-0">
                <div class="flex items-center justify-between p-3 bg-white/60 backdrop-blur-md rounded-2xl shadow-sm border border-blue-50/50 hover:bg-white transition-all">
                    ...
                    <form method="POST" action="{{ route('logout') }}" hx-boost="false" title="Đăng xuất khỏi hệ thống">
                        @csrf
                        <button type="submit" class="text-red-500 hover:text-red-700 p-2 bg-red-50 hover:bg-red-100 rounded-lg transition-all hover:scale-110 flex items-center justify-center">
            ...
            <header class="flex items-center justify-between px-10 py-6 border-b border-slate-200/60 sticky top-0 bg-white/80 backdrop-blur-xl z-40 shadow-sm">
                <div class="flex flex-col">
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        ...
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]">Hệ thống Xếp lịch Thông minh</p>
                    </div>
                </div>
